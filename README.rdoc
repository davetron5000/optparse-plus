<i>Developed using <a href="http://tom.preston-werner.com/2010/08/23/readme-driven-development.html">Readme-driven development</a>; that's why there's only a README</i>
